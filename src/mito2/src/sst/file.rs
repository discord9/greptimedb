...
pub struct FileMeta {
    ...
    /// `experimental_preserve_row_sequence` enabled (append-only tables). Absent
...
mod tests {
    ...
    fn test_file_meta_indexes_backward_compatibility() {
        ...
        // Missing preserve_row_sequence in legacy manifests defaults to false.
    ...
    fn test_file_meta_preserve_row_sequence_serde() {
        ...
        // False is omitted from serialized output for compact manifests.
