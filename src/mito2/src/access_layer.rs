...
pub struct SstWriteRequest {
    ...
    /// Whether the SST should store per-row sequences instead of normalizing the
    /// sequence column to the file's max sequence (`experimental_preserve_row_sequence`).
