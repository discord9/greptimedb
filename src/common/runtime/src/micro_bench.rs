...
mod tests {
    ...
    fn class_outcome_admission_wait_deltas() {
        ...
        let mut before = catio::ClassStats::default();
        before.admitted = 10;
        before.total_admission_wait = Duration::from_millis(100);

        // after: 20 admitted tasks, 500 ms cumulative wait
        let mut after = catio::ClassStats::default();
        after.admitted = 20;
        after.total_admission_wait = Duration::from_millis(500);
    ...
    fn class_outcome_admission_wait_zero_guards() {
        ...
        let mut after = catio::ClassStats::default();
        after.total_admission_wait = Duration::from_millis(100);
        ...
        let mut before = catio::ClassStats::default();
        before.admitted = 5;
        before.total_admission_wait = Duration::from_millis(200);
